...
export default function TestimonialsSection() {
  ...
  const testimonials = [
    {
      id: 1,
      name: "Abdullah Srwan Kareem Abdulla",
      position: "Director",
      company: "Asia Trading Export",
      image: "AS",
      rating: 5,
      testimonial: "Nexus Development helped give my company credibility in the digital scene. My customers can now easily access my services online, leading to a significant boost in sales and customer engagement. Their team's professionalism and expertise were evident throughout the project.",
      project: "Asian Trading Export Website",
      metrics: { improvement: "150%", timeline: "Early", satisfaction: "100%" },
    },
    {
      id: 2,
      name: "Maher Ratib Hammuda",
      position: "Founder",
      company: "Coco Hamoodah",
      image: "AM",
      rating: 5,
      testimonial: "Working with Nexus was a pleasure to say the least. They took the time to understand my vision and created exactly what i needed for my business. The new website has not only attracted more customers but also enhanced my brand's image significantly.",
      project: "Charcoal Briquettes Website",
      metrics: { improvement: "200x", timeline: "On-Time", satisfaction: "99%" },
    },
  ];
